...
/**
 * Created by Personal Pc on 1/18/2018.
 */
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                //Toast.makeText(mContext, "gps and network disabled", Toast.LENGTH_SHORT).show();
                ...
                if (isNetworkEnabled) {
                    if (ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        //Toast.makeText(mContext,"Please allow gps provider to get your location",Toast.LENGTH_LONG).show();
               ...
               // else
                   // Toast.makeText(mContext, "Network disabled", Toast.LENGTH_SHORT).show();
